#### Alana Dec 7 2022 - I don't know what this script was made for....
#I made it into a function so I could at least build the source
...
#'
#' @examples
PSP_summary <- function(SORTIE.species){
  ...
  for(i in 1:num.meas){
    ...
    red.plot.SORTIE.meas <- plot.SORTIE.meas[,.(samp_id,meas_yr,phf_tree,sp_PSP,dbh,ld,LD_Group,age_tot,height,batree,baha)]
    #just live species
